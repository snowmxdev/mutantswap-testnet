import { JSBI, Pair, Percent } from '@mutantswap/sdk'
...
import { TokenPairBackgroundColor } from '../earn/PoolCardMCOIN.styles'
...
export const HoverCard = styled(Card)`
  ...
  :hover {
    border: 1px solid ${({ theme }) => darken(0.06, theme.primary4)};
  }
`
...
export default function FullPositionCard({ pair, border }: PositionCardProps) {
  ...
  // const backgroundColor1 = useColorWithDefault('#1F1F1E', token0)
  // const backgroundColor2 = useColorWithDefault('#2F2F2F', token1)
