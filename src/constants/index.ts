import { ChainId, JSBI, Percent, Token, WETH as _WETH } from '@mutantswap/sdk'
...
export const MCOIN: { [chainId in ChainId]: Token } = {
  [ChainId.FUJI]: new Token(ChainId.FUJI, ZERO_ADDRESS, 18, 'MCOIN', 'MutantCoin'),
  [ChainId.AVALANCHE]: new Token(ChainId.AVALANCHE, ZERO_ADDRESS, 18, 'MCOIN', 'MutantCoin'),
  [ChainId.POLYGON]: new Token(ChainId.POLYGON, ZERO_ADDRESS, 18, 'MCOIN', 'MutantCoin'),
  [ChainId.AURORA]: new Token(
    ChainId.AURORA,
    '0x00a4d2C1754A0d276dCc26EC4B6d7052fb0DBd73', //TODO: update MCOIN mainnet address
    18,
    'MCOIN',
    'MutantCoin'
  )
...
export const rMC: { [chainId in ChainId]: Token } = {
  [ChainId.FUJI]: new Token(ChainId.FUJI, ZERO_ADDRESS, 18, 'rMC', 'MutantCoin'),
  [ChainId.AVALANCHE]: new Token(ChainId.AVALANCHE, ZERO_ADDRESS, 18, 'rMC', 'MutantCoin'),
  [ChainId.POLYGON]: new Token(ChainId.POLYGON, ZERO_ADDRESS, 18, 'rMC', 'MutantCoin'),
  [ChainId.AURORA]: new Token(
    ChainId.AURORA,
    '0xf3206383A2151212E96EDA3523C5bB1351F368f0', //TODO: update MCO mainnet address
    18,
    'rMC',
    'MutantCoin'
  )
...
export const XMCOIN: { [chainId in ChainId]: Token } = {
  [ChainId.FUJI]: new Token(ChainId.FUJI, ZERO_ADDRESS, 18, 'xMC', 'MCBar Token'),
  [ChainId.AVALANCHE]: new Token(ChainId.AVALANCHE, ZERO_ADDRESS, 18, 'xMC', 'MCBar Token'),
  [ChainId.POLYGON]: new Token(ChainId.POLYGON, ZERO_ADDRESS, 18, 'xMC', 'MCBar Token'),
  [ChainId.AURORA]: new Token(ChainId.AURORA, '0x5F6C8b51fcaff16673134D64A529f1E0Eb995544', 18, 'xMC', 'MCBar Token') //TODO: change to xMC mainnet address
}
...
export const fUSDC: { [chainId in ChainId]: Token } = {
  [ChainId.FUJI]: new Token(ChainId.FUJI, ZERO_ADDRESS, 6, 'USDC', 'USDC Stablecoin'),
  [ChainId.AVALANCHE]: new Token(
    ChainId.AVALANCHE,
    '0xA7D7079b0FEaD91F3e65f86E8915Cb59c1a4C664',
  ...
  [ChainId.AURORA]: new Token(
    ChainId.AURORA,
    '0x61106e8ee4d7DA217fCB1868F3c6123F08b7bcAE',
    6,
    'fUSDC',
    'Fake USDC Stablecoin'
  )
}
...
export const fNEAR: { [chainId in ChainId]: Token } = {
  [ChainId.FUJI]: new Token(ChainId.FUJI, ZERO_ADDRESS, 18, 'fNEAR', 'fNEAR Token'),
  [ChainId.AVALANCHE]: new Token(ChainId.AVALANCHE, ZERO_ADDRESS, 18, 'fNEAR', 'fNEAR Token'),
  [ChainId.POLYGON]: new Token(ChainId.AVALANCHE, ZERO_ADDRESS, 18, 'fNEAR', 'fNEAR Token'),
  [ChainId.AURORA]: new Token(ChainId.AURORA, '0x7bE946EBcb039f494Ec5767006EA37eBfb4906A4', 24, 'fNEAR', 'fNEAR Token')
}
...
export const CLAIM_ADDRESS: { [chainId in ChainId]?: string } = {
  [ChainId.FUJI]: ZERO_ADDRESS,
  [ChainId.AVALANCHE]: ZERO_ADDRESS,
  [ChainId.POLYGON]: ZERO_ADDRESS,
  [ChainId.AURORA]: '0xb3b399AE7B245D5273f58f3445B0F8c9435a46Ba'
}

export const IDO_ADDRESS: { [chainId in ChainId]?: string } = {
  [ChainId.FUJI]: ZERO_ADDRESS,
  [ChainId.AVALANCHE]: ZERO_ADDRESS,
  [ChainId.POLYGON]: ZERO_ADDRESS,
  [ChainId.AURORA]: '0x13f683573958727464a427cee8592f44f9645B28' //TODO: change to mainnet address
}
...
const COMMON_BASES: ChainTokenList = {
  ...
  [ChainId.AURORA]: [WNEAR[ChainId.AURORA], USDT[ChainId.AURORA], createProperlyNamedWETH(), MCOIN[ChainId.AURORA]] //TODO: change MCOIN to MCOIN
}
